...
public class CameraInfo implements Serializable{
    private static final long serialVersionUID = 7245609160053074102L;
...
/*    public String getStartTime() {
    ...
    public String toString() {
        return "Camera [username=" + username + ", password=" + password + ", ip=" + ip + ", channel=" + channel
                + ", stream=" + stream + ", rtsp=" + rtsp +
                //", rtmp=" + rtmp +
                ", url=" + url + ", startTime="
